...
;(function ( $, window, document, undefined ) {
		...
		DateTimePicker.prototype = {
			...
			_setOutput: function()
			{
                ...
                var iSeconds = dtPickerObj.dataObject.dCurrentDate.getSeconds();
			...
			_addEventHandlersForPicker: function()
			{
                ...
                $(dtPickerObj.element).find(".seconds .increment").click(function(e)
                {
                    dtPickerObj.dataObject.iCurrentSeconds++;
                    dtPickerObj._setCurrentDate();
                    dtPickerObj._setOutputOnIncrementOrDecrement();
                });

                $(dtPickerObj.element).find(".seconds .decrement").click(function(e)
                {
                    dtPickerObj.dataObject.iCurrentSeconds--;
                    dtPickerObj._setCurrentDate();
                    dtPickerObj._setOutputOnIncrementOrDecrement();
			...
			_parseDateTime: function(sDateTime)
			{
				...
				var iHour = dTempDate.getHours();
				var iMinutes = dTempDate.getMinutes();
                var iSeconds = dTempDate.getSeconds();
				var sMeridiem = "";
			...
			_getValuesFromInputBoxes: function()
			{
				...
				if(dtPickerObj._compare(dtPickerObj.settings.mode, "time") || dtPickerObj._compare(dtPickerObj.settings.mode, "datetime"))
				{
                    ...
                    dtPickerObj.dataObject.iCurrentSeconds = parseInt($(dtPickerObj.element).find(".seconds .dtpicker-compvalue").val());
			...
			_setCurrentDate: function()
			{
				...
				else if(dtPickerObj._compare(dtPickerObj.settings.mode, "datetime"))
				{
                    ...
                    var sSeconds = dtPickerObj.dataObject.iCurrentSeconds;
					...
					var sTime = sHour + dtPickerObj.settings.timeSeparator + sMinutes + dtPickerObj.settings.timeSeparator + sSeconds;
					if(dtPickerObj.dataObject.bIs12Hour)
						sTime += dtPickerObj.settings.timeMeridiemSeparator + dtPickerObj.dataObject.sCurrentMeridiem;
			...
			_setButtons: function()
			{
				...
				if(dtPickerObj.dataObject.dMaxValue != null)
				{
					if(dtPickerObj._compare(dtPickerObj.settings.mode, "time"))
					{
                        ...
                        //Decrement Seconds
                        if(dtPickerObj.dataObject.iCurrentSecond >= dtPickerObj.dataObject.dMaxValue.getHours() && (dtPickerObj.dataObject.iCurrentSecond + 1) > dtPickerObj.dataObject.dMaxValue.getSeconds())
			...
			_compareDateTime: function(dDate1, dDate2)
			{
				...
				if((dDate1.getDate() == dDate2.getDate() && dDate1.getMonth() == dDate2.getMonth() && dDate1.getFullYear() == dDate2.getFullYear()) && (dDate1.getHours() == dDate2.getHours()) && (dDate1.getMinutes() == dDate2.getMinutes()) && (dDate1.getSeconds() == dDate2.getSeconds()))
						...
						else if(dDate1.getMonth() == dDate2.getMonth())
						{
							...
							else if(dDate1.getDate() == dDate2.getDate())
							{
								...
								else if(dDate1.getHours() == dDate2.getHours())
								{
                                    ...
                                    {
                                        if(dDate1.getSeconds() < dDate2.getSeconds())
                                            iDateTimeMatch = 2;     // date1 < date2
                                        else if(dDate1.getSeconds() > dDate2.getSeconds())
                                            iDateTimeMatch = 3;     //date1 > date2
                                    }
